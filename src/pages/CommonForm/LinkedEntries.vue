<template>
  <div
    class="w-quick-edit bg-card border-l border-border overflow-y-auto custom-scroll custom-scroll-thumb2"
  >
    <!-- Page Header -->
    <div
    ...
    >
      ...
      >
        ...
        >
          <h2 class="text-base text-muted-foreground font-semibold select-none">
        ...
        >
          ...
          <div
            ...
            class="p-2 text-sm cursor-pointer border-b last:border-0 border-border hover:bg-accent"
          ...
          >
            <div class="flex justify-between">
              ...
              <!-- Date -->
              <p v-if="e.date" class="text-xs text-muted-foreground">
