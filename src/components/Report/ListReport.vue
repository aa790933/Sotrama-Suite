<template>
  <div class="overflow-hidden flex flex-col h-full">
    ...
    <div v-if="dataSlice.length" class="overflow-hidden">
      ...
      <div
        ref="titlerow"
        class="w-full overflow-x-hidden flex items-center border-b border-border px-4"
        :style="{
          height: `${hconst}px`,
        ...
        <template v-for="(row, r) in dataSlice" :key="r + '-row'">
          <div
            ...
            :class="[
              ...
              row.isGroup ? 'hover:bg-accent cursor-pointer' : '',
            ]"
    ...
    <p v-else class="w-full text-center mt-20 text-foreground text-base">
