<template>
  <div class="flex gap-2">
    ...
    >
      <Row
        :ratio="ratio"
        class="mt-2 px-2 w-full flex items-center border rounded-t-md text-muted-foreground border-border"
      >
        <div
      ...
      <Row
        ...
        :ratio="ratio"
        :border="true"
        class="px-2 w-full border flex items-center justify-center group h-row-mid hover:bg-accent border-border"
