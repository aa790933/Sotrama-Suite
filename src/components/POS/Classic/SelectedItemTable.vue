<template>
  <Row
    :ratio="ratio"
    class="border border-border rounded-t px-2 text-muted-foreground w-full flex items-center mt-2"
  >
    <div
      v-if="tableFields"
  ...
  >
    <Row
      ...
      :ratio="ratio"
      class="border border-border w-full px-2 py-2 group flex items-center justify-center hover:bg-accent"
    >
      <SelectedItemRow
