...
export class TelemetryManager {
  ...
  #sendBeacon(verb: Verb, noun: Noun, more?: Record<string, unknown>) {
    try {
      ...
      // navigator.sendBeacon only accepts http(s) origins; packaged desktop
      // builds run on a custom protocol (e.g. app://), where it throws a
      // TypeError. No-op there instead of propagating to the renderer boot.
      if (
